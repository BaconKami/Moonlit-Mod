...
import com.multiversequeen.moonlit.client.MoonlitRenderer;
import com.multiversequeen.moonlit.entities.CustomEntities;
...
public class Moonlit {
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(CustomEntities.MOONLIT.get(), MoonlitRenderer::new);
    }
