...
public class CustomDripParticle extends SpriteTexturedParticle {
    ...
    public static class DrippingRemediumLavaFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            CustomDripParticle.DrippingRemediumLava dripparticle$drippinglava = new CustomDripParticle.DrippingRemediumLava(worldIn, x, y, z, CustomFluids.REMEDIUM_LAVA.get(), CustomParticleTypes.FALLING_REMEDIUM_LAVA.get());
    ...
    public static class FallingRemediumLavaFactory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            CustomDripParticle dripparticle = new CustomDripParticle.FallingLiquidParticle(worldIn, x, y, z, CustomFluids.REMEDIUM_LAVA.get(), CustomParticleTypes.LANDING_REMEDIUM_LAVA.get());
